    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('busy', 'Busy'), ('away', 'Away'), ('available', 'Available')], default='available', max_length=255)),
                ('otp', models.CharField(blank=True, max_length=6)),
                ('otp_expiry_time', models.DateTimeField(blank=True, null=True)),
                ('two_factor', models.BooleanField(default=False)),
                ('avatar', models.ImageField(default='yoshi.jpg', upload_to='avatars/')),
